            ...
            <div className="flex items-center justify-center min-h-screen bg-white">
                <div className="relative flex flex-col m-6 p-2 gap-4 space-y-8   md:flex-row md:space-y-0 max-w-[1100px]">
                    ...
                    <div className="flex flex-col justify-center p-8 md:p-8 border-2 border-[#FAAF19] py-8 rounded-lg md:w-1/2 bg-white">
                        ...
                        <form action="">
                            <div className="py-2">
                                <label className="mb-2 text-md">Register E-mail</label>
                                <input
                                    type="text"
                            ...
                            <div className="py-2">
                                <label className="mb-2 text-md">Re-enter Password</label>
                                <input
                                    type="password"
                                    name="pass"
                                    id="pass"
                        ...
                        <button className="w-full mt-6 py-4 bg-[#545AFA] text-white p-2 rounded-md mb-6 hover:bg-white hover:text-black hover:border hover:border-gray-300">
                            Save
                        </button>
                    </div>
                </div>
