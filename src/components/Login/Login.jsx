...
const Login = () => {
    return (
        <section className=" min-h-screen flex items-center justify-center">
            <div className=" flex max-w-[1100px] p-5 items-center gap-4 ">
                ...
                <div className="md:w-1/2 px-4 md:px-10 border-2 border-[#FAAF19] py-8 rounded-lg">
                    <h2 className="font-bold text-2xl text-black text-center">Log in</h2>
                    ...
                    <div className="mt-4 px-12 grid grid-cols-3 items-center text-gray-400">
                        <hr className="border-gray-400" />
                        <p className="text-center text-sm">Or</p>
                        <hr className="border-gray-400" />
                    </div>

                    <button className="bg-white border px-1 py-2 w-full rounded-md mt-3 flex text-center text-sm  text-black font-medium">
                        <svg
                            className="mr-3"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 48 48"
                    ...
                    <div className="mt-3 text-xs flex justify-center gap-1 items-center text-black">
                        <p className=" text-xs text-gray-300">Don't have an account?</p>
                        <Link to="/SignUp" className="text-[#545AFA]">Sign up</Link>
                    </div>
                </div>
            </div>
        </section>
